package fr.herisson.missa.config;
...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if (this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    .defaultClusteredBuilder().defaultCacheName("infinispan-Missa-cluster-cache").transport().defaultTransport()
                    .addProperty("configurationFile", jHipsterProperties.getCache().getInfinispan().getConfigFile())
                    .clusterName("infinispan-Missa-cluster").globalJmxStatistics()
                ...
                return () -> GlobalConfigurationBuilder
                    .defaultClusteredBuilder().defaultCacheName("infinispan-Missa-cluster-cache").transport()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream.of(fr.herisson.missa.repository.UserRepository.USERS_BY_LOGIN_CACHE, fr.herisson.missa.repository.UserRepository.USERS_BY_EMAIL_CACHE)
